...
class DriverList extends PureComponent {
  ...
  render() {
    const { OPEN_CITY, form } = this.props;
    const { getFieldDecorator } = form;
    const { list, pageNum, totalNum } = this.state;
    const columns = [
      {
        title: '编号',
        key: 'id',
      ...
      },
      {
        title: '所属城市',
        key: 'adcode',
        render: (text, record) => OPEN_CITY[record.adcode],
      },
      {
        title: '订单量',
        key: 'orderCount',
      ...
      },
      {
        ...
        key: 'address',
        render: (text, record) =>
          record.address ? <span>{record.address.address}</span> : <AddressModal />,
      },
      {
        title: '操作',
        render: (text, record) => (
      ...
      <Fragment>
        <Form layout="inline">
          ...
          <Form.Item label="司机姓名">
            {getFieldDecorator('name', {})(<Input allowClear placeholder="司机姓名" />)}
          </Form.Item>
          <Form.Item label="手机号">
            {getFieldDecorator('mobile', {})(<Input allowClear placeholder="手机号" />)}
          </Form.Item>
          <Form.Item label="车牌号">
            {getFieldDecorator('plateNo', {})(<Input allowClear placeholder="车牌号" />)}
          </Form.Item>
          <Form.Item>
